...
/*
   ...
   - sqlite-ba a fogadott kereskedĂ©sek azonositoit berakja orderID
   - vĂ©letlenszerĹ± stringet be kell ĂˇllĂ­tani mt4ID, amit szintĂ©n tĂˇrol az
     adatbĂˇzisban. Ezzel a slave tĂ¶bb mt4-ben is tudja kezelni az sqlite
     ban tĂˇrolt kereskedĂ©seket!
